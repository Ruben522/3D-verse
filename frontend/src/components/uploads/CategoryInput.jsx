...
const CategoryInput = () => {
    ...
    return (
        <div>
            <label className="text-sm font-bold text-gray-700 block mb-2">Categorías (Opcional)</label>
            ...
            <p className="text-xs text-gray-400 font-medium mt-2 ml-1">Puedes seleccionar más de una opción.</p>
        </div>
    );
};
