    ...
    <div className="py-6 animate-fade-in">
      {models && models.length > 0 ? (
          ...
          {models.map(model => (
            ...
            >
              <div className="aspect-square bg-gray-100 overflow-hidden relative">
                ...
                {/* Etiqueta flotante de descargas */}
        ...
        <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-gray-200 border-dashed">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">No hay diseños todavía</h3>
          <p className="text-gray-500 text-center max-w-md">Este usuario aún no ha compartido ninguna de sus creaciones 3D con la comunidad.</p>
        </div>
      )}
    </div>
  );
