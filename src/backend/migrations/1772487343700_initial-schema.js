...
export async function up(pgm) {
    // Aquí metemos tu SQL exacto. node-pg-migrate permite inyectar SQL puro
    // lo cual es ideal para proyectos que ya tenían su diseño hecho.
    pgm.sql(`
    -- ENUM for user roles (Añadimos comprobación)
    DO $$ BEGIN
...
export async function down(pgm) {
    // El método down es para deshacer la migración. Borramos en orden inverso.
    pgm.sql(`
